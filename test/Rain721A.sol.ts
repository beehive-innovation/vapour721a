...
// 		const [vmStateConfig, currencies] = Rain1155.generateScript(
// 			[canMint],
// 			prices
// 		);
...
// 		rain721a = (await rain721Contract.deploy(
// 			rain721aConstructorConfig
// 		)) as Rain721A;
...
// 		await expect(
// 			rain721a.initialize(rain721aInitializeConfig)
...
// 			rain721aConstructorConfig.baseURI
// 		);
...
// 		await expect(rain721a.connect(owner).mintNFT(1)).to.be.revertedWith(
// 			"MAX_LIMIT"
// 		);
// 	});
