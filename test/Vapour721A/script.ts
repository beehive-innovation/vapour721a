...
//       const vmStateConfig: StateConfigStruct = VM.pair(
//         VM.ifelse(
...
//     const tokenIsLessThan = (endToken: number): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
...
//     const tokenIsGreaterThan = (token: number): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
//             op(Opcode.IERC721A_TOTAL_MINTED),
...
//     const receiverAddressIsIn = (addresses: string[]): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
...
//     const maxCapForWallet = (cap: number): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
...
//     const remainingUnits = (): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
//             op(Opcode.STORAGE, StorageOpcodes.SUPPLY_LIMIT),
...
//     const rule = (number: number): StateConfigStruct => {
//       return {
//         sources: [
//           concat([
...
//       const vmStateConfig: StateConfigStruct = VM.multi(
//         [
//           ...rules,
//           // quantity script
//           VM.ifelse(
